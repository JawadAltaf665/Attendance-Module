...
namespace AttendanceModule.Migrations
{
    ...
    [Migration("20250908095434_RequestApprovedShiftSwap")]
    partial class RequestApprovedShiftSwap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttendanceModule.AttendanceModuleEntities.AttendanceEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AttendanceModule.AttendanceModuleEntities.Roster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AttendanceModule.AttendanceModuleEntities.Shift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AttendanceModule.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AttendanceModule.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AttendanceModule.AttendanceModuleEntities.AttendanceEvent", b =>
                {
                    b.HasOne("AttendanceModule.AttendanceModuleEntities.Employee", "Employee")

...
{
    public abstract class AttendanceModuleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AttendanceModuleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AttendanceModuleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AttendanceModuleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AttendanceModuleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AttendanceModuleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AttendanceModuleDbContext, Task<T>> func)
        {
            T result;
